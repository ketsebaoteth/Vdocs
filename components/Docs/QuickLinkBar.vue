...
<template>
    <div class="w-96 h-screen bg-background p-8 sticky top-16 relative">
      ...
      <p class="pl-4 my-2">on this page</p>
      <ul class="flex flex-col gap-1 z-10">
        <li
  ...
  function updateIndicator() {
    ...
    const elementRect = activeElement.getBoundingClientRect();
      const containerRect = document.querySelector('.w-96').getBoundingClientRect(); // Get container rect
