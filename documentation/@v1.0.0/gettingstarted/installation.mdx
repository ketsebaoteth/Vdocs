...
<Codeblock lang="shell" details="~vscodeTerminal~" content="npm install //or any compatible package manager as always" />

after running the command, you vdocs project is ready to run. you can start the project by running the following command:

<Codeblock lang="shell" details="~vscodeTerminal~" content="npm run dev //or any compatible package manager as always" />
